...
import com.hashinology.geofencingapi.util.Constants
import com.hashinology.geofencingapi.util.Constants.PREFERENCE_FIRST_LAUNCE
...
class DataStoreRepository @Inject constructor(@ApplicationContext private val context: Context) {
    private object PreferenceKey{
        val firstLaunch = booleanPreferencesKey(PREFERENCE_FIRST_LAUNCE)
    }
